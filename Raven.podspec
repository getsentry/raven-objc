#
# Be sure to run `pod spec lint Raven.podspec' to ensure this is a
# valid spec.
#
...
Pod::Spec.new do |s|
  ...
  # s.description  = <<-DESC
  #                   An optional longer description of Raven
  #
  #                   * Markdown format.
  ...
  # s.authors      = { "David Cramer" => "dcramer@gmail.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'David Cramer', 'other author'
